...
// VK_Model
VK_Model::VK_Model(std::shared_ptr<VK_Device> device, const std::vector<Vertex>& verticies)
    : m_Device(device)
{
...
void VK_Model::CreateVertexBuffers(const std::vector<Vertex>& verticies)
{
    m_VertexCount = static_cast<uint>(verticies.size());
